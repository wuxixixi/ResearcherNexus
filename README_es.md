...
ResearcherNexuses un marco de Investigación Profunda impulsado por la comunidad que se basa en el increíble trabajo de la comunidad de código abierto. Nuestro objetivo es combinar modelos de lenguaje con herramientas especializadas para tareas como búsqueda web, rastreo y ejecución de código Python, mientras devolvemos a la comunidad que hizo esto posible.

Por favor, visita [nuestra página web oficial](https://ResearcherNexus.tech/) para más detalles.
...
En esta demostración, mostramos cómo usar ResearcherNexus para:
...
- [¿Qué altura tiene la Torre Eiffel comparada con el edificio más alto?](https://ResearcherNexus.tech/chat?replay=eiffel-tower-vs-tallest-building)
- [¿Cuáles son los repositorios más populares en GitHub?](https://ResearcherNexus.tech/chat?replay=github-top-trending-repo)
- [Escribir un artículo sobre los platos tradicionales de Nanjing](https://ResearcherNexus.tech/chat?replay=nanjing-traditional-dishes)
- [¿Cómo decorar un apartamento de alquiler?](https://ResearcherNexus.tech/chat?replay=rental-apartment-decoration)
- [Visita nuestra página web oficial para explorar más repeticiones.](https://ResearcherNexus.tech/#case-studies)
...
ResearcherNexus está desarrollado en Python y viene con una interfaz web escrita en Node.js. Para garantizar un proceso de configuración sin problemas, recomendamos utilizar las siguientes herramientas:
...
ResearcherNexus soporta múltiples motores de búsqueda que pueden configurarse en tu archivo `.env` usando la variable `SEARCH_API`:
...
ResearcherNexus ahora incluye una función de Texto a Voz (TTS) que te permite convertir informes de investigación a voz. Esta función utiliza la API TTS de volcengine para generar audio de alta calidad a partir de texto. Características como velocidad, volumen y tono también son personalizables.
...
ResearcherNexus utiliza LangGraph para su arquitectura de flujo de trabajo. Puedes usar LangGraph Studio para depurar y visualizar el flujo de trabajo en tiempo real.

#### Ejecutando LangGraph Studio Localmente

ResearcherNexus incluye un archivo de configuración `langgraph.json` que define la estructura del grafo y las dependencias para LangGraph Studio. Este archivo apunta a los grafos de flujo de trabajo definidos en el proyecto y carga automáticamente variables de entorno desde el archivo `.env`.
...
ResearcherNexus soporta el rastreo de LangSmith para ayudarte a depurar y monitorear tus flujos de trabajo. Para habilitar el rastreo de LangSmith:
...
```bash
# Reemplaza ResearcherNexus-api-app con tu nombre de contenedor preferido
...
ResearcherNexus proporciona una configuración docker-compose para ejecutar fácilmente tanto el backend como el frontend juntos:
...
Los siguientes ejemplos demuestran las capacidades de ResearcherNexus:
...
ResearcherNexus incluye un mecanismo de humano en el bucle que te permite revisar, editar y aprobar planes de investigación antes de que sean ejecutados:
...
ResearcherNexus está construido sobre el increíble trabajo de la comunidad de código abierto. Estamos profundamente agradecidos a todos los proyectos y contribuyentes cuyos esfuerzos han hecho posible ResearcherNexus. Verdaderamente, nos apoyamos en hombros de gigantes.
...
- **[LangGraph](https://github.com/langchain-ai/langgraph)**: Su enfoque innovador para la orquestación multi-agente ha sido instrumental en permitir los sofisticados flujos de trabajo de ResearcherNexus.
...
Un sentido agradecimiento va para los autores principales de `ResearcherNexus`, cuya visión, pasión y dedicación han dado vida a este proyecto:

- **[Daniel Walnut](https://github.com/hetaoBackend/)**
- **[Henry Li](https://github.com/magiccube/)**

Su compromiso inquebrantable y experiencia han sido la fuerza impulsora detrás del éxito de ResearcherNexus. Nos sentimos honrados de tenerlos al timón de este viaje.

## Historial de Estrellas

[![Gráfico de Historial de Estrellas](https://api.star-history.com/svg?repos=bytedance/ResearcherNexus&type=Date)](https://star-history.com/#bytedance/ResearcherNexus&Date) 